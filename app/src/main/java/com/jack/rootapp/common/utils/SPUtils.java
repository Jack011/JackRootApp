...
import com.jack.rootapp.base.Constant;
...
public class SPUtils {
    ...
    public static void putValue(Context context, String key,
                                int value) {
        SharedPreferences.Editor sp = getEditor(context, Constant.SP_DEFAULT_NAME);
        sp.putInt(key, value);
        sp.commit();
    }
    ...
    public static int getValue(Context context, String key,
                               int defValue) {
        SharedPreferences sp = getSharedPreferences(context, Constant.SP_DEFAULT_NAME);
